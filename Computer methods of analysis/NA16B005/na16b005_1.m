...
I=[1.5 1]; % moment of inertia
L=[5 4]; % length in m
m=[1 2]; % member number
uu=2; % Number of unrestrained degree of freedom 
ur=4; % Number of restrained degree of freedom 
uul=[1 2]; % global labels of unrestrained dof
url=[3 4 5 6]; % global labels of restrained dof
l1=[3 1 4 5]; % global labels for member 1
l2=[1 2 5 6]; % global labels for member 2
l=[l1;l2];
Ktotal=zeros (6);
fem1=[62.5;-62.5;75;75]; % Local fixed end moments of member 1
fem2=[12.5;-12.5;15;15]; % Local fixed end moments of member 2
...
jl=[50;12.5;-62.5;-75;-90;-15;];  % values given in kN or kNm
jlu=[50;12.5];  % load vector in unrestrained dof
delu=KuuInv*jlu;
