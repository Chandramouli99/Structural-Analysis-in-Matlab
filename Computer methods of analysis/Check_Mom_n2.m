...
l=[l1;l2];
Ktotal=zeros (6);
fem1=[62.5;-62.5;50;50]; % Local fixed end moments of member 1
fem2=[93.75;-93.75;75;75]; % Local fixed end moments of member 2
...
jl=[-31.25;-62.5;93.75;-50;-125;-75];  % values given in kN or kNm
jlu=[-31.25];  % load vector in unrestrained dof
delu=KuuInv*jlu;
