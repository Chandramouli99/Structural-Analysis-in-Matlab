...
uul=[1 2 3 4]; % global labels of unrestrained dof
url=[5 6 7 8]; % global labels of restrained dof
l1=[1 2 5 6]; % global labels for member 1
l2=[2 3 6 7]; % global labels for member 2
l3=[3 4 7 8]; % global labels for member 3
l=[l1;l2;l3];
Ktotal=zeros (8);
fem1=[30;-30;30;30]; % Local fixed end moments of member 1
fem2=[40;-40;30;30]; % Local fixed end moments of member 2
fem3=[45;-45;45;45]; % Local fixed end moments of member 3
...
jl=[-30;-10;-5;45;-30;-60;-75;-45];  % values given in kN or kNm
jlu=[-30;-10;-5;45];  % load vector in unrestrained dof
delu=KuuInv*jlu;
