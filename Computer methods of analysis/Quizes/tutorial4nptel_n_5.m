...
L=[4.242 3 3 4.42 3]; %length in m
A=[1 1 1 1 1]; %Area in m2
theta=[45 0 0 -45 -90];  %angle in degrees
uu=5; %Number of unrestrained degrees of freedom
ur=3; %Number of restrained degrees of freedom 
uul=[1 2 3 4 5];
url=[6 7 9];
l1=[6 2 5 1];
l2=[6 4 5 3];
