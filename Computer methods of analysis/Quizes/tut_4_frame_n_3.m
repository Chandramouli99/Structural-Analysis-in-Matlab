...
l1=[2 4 3 6]; % global labels for member 1
l2=[2 1 7 9 ]; % global labels for member 2
l3=[1 8 3 9];
l=[l1;l2;l3];
Ktotal=zeros (9);
fem1=[0;0;0;0]; % Local fixed end moments of member 1
fem2=[60;-60;40;40]; % Local fixed end moments of member 2
fem3=[0;0;0;0];
...
jl=[60;-60;0;0;0;0;-40;0;-40];  % values given in kN or kNm
jlu=[60;-60;0];  % load vector in unrestrained dof
delu=KuuInv*jlu;
