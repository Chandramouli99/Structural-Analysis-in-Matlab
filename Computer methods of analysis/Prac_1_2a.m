...
l=[l1;l2];
Ktotal=zeros (6);
fem2=[5;-5;5;5]; % Local fixed end moments of member 1
fem1=[10;-10;10;10]; % Local fixed end moments of member 2
...
jl=[5;5;-10;-10;-15;-5];  % values given in kN or kNm
jlu=[5;5];  % load vector in unrestrained dof
delu=KuuInv*jlu;
