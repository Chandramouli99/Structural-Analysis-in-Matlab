...
l1=[4 3 5 6]; % global labels for member 1
l2=[3 2 6 7]; % global labels for member 2
l3=[2 1 7 8];
l=[l1;l2;l3];
Ktotal=zeros (dof);
fem1=[3.75;-3.75;5;5]; % Local fixed end moments of member 1
fem2=[41.67;-41.67;50;50]; % Local fixed end moments of member 2
fem3=[5;-5;10;10];
...
jlu=[5;36.67;-37.92];  % load vector in unrestrained dof
delu=KuuInv*jlu;
