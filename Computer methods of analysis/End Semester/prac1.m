...
l1=[3 1 5 6]; % global labels for member 1
l2=[1 2 6 7]; % global labels for member 2
l3=[2 4 7 8];
l=[l1;l2;l3];
Ktotal=zeros (8);
fem1=[30;-30;40;40]; % Local fixed end moments of member 1
...
jlu=[-36.367;46.67];  % load vector in unrestrained dof
delu=KuuInv*jlu;
