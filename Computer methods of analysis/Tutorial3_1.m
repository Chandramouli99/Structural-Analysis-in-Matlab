...
l=[l1;l2;l3];
Ktotal=zeros (9);
fem1=[-12.5;-12.5;-25;-25]; % Local fixed end moments of member 1
fem2=[45;-45;45;45]; % Local fixed end moments of member 2
fem3=[0;0;0;0];
...
jl=[-32.5;45;15;-12.5;-45;15;0;-45;0];  % values given in kN or kNm
jlu=[-32.5;45;15];  % load vector in unrestrained dof
delu=KuuInv*jlu;
